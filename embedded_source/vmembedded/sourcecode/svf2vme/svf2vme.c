...
{
	while ( number > 0x007F ) {
		write( ( unsigned char ) ( ( number & 0x007F ) + 0x0080 ) );
        number = number >> 7;
	}
...
int main( int argc, char *argv[] )
{
    ...
    printf( "\n      ispVME(tm) SVF Compiler Version %s IEEE 1532 Copyright 1998-2011\n\n", VME_VERSION_NUMBER );
